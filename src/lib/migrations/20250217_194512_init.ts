...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE IF NOT EXISTS "public"."enum_users_roles" AS ENUM('admin', 'customer');
  CREATE TYPE IF NOT EXISTS "public"."enum_orders_status" AS ENUM('canceled', 'processing', 'requires_action', 'requires_capture', 'requires_confirmation', 'requires_payment_method', 'succeeded');
  CREATE TYPE IF NOT EXISTS "public"."enum_products_compatibility" AS ENUM('swimspa', 'hottub', 'pool');
  CREATE TYPE IF NOT EXISTS "public"."enum_products_status" AS ENUM('draft', 'published');
  CREATE TYPE IF NOT EXISTS "public"."enum__products_v_version_compatibility" AS ENUM('swimspa', 'hottub', 'pool');
  CREATE TYPE IF NOT EXISTS "public"."enum__products_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_hero_slides_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_hero_slides_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_banner_style" AS ENUM('info', 'warning', 'error', 'success');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_code_language" AS ENUM('typescript', 'javascript', 'css');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_media_block_position" AS ENUM('default', 'fullscreen');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_typography_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_typography_links_link_appearance" AS ENUM('default', 'secondary', 'none');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_typography_type" AS ENUM('sub-title-body', 'title-body', 'title', 'subtitle', 'body');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_typography_align" AS ENUM('left', 'center', 'right');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_card_type" AS ENUM('icon', 'product', 'service');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_card_icon" AS ENUM('moon', 'heart-eyes', 'swimming', 'walking', 'wave', 'theater-masks', 'heart', 'sleeping', 'stress', 'aches', 'sick');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_grid_content_content_type" AS ENUM('blocks', 'richText');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_grid_grid_style" AS ENUM('basic', 'masonry', 'responsive');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_content_columns_type" AS ENUM('blocks', 'richText');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_content_columns_align" AS ENUM('start', 'center', 'end');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_services_offerings_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_services_offerings_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_services_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_services_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_testimonials_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_testimonials_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_testimonials_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_latest_posts_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_latest_posts_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_featured_spas_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_featured_spas_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_hero_type" AS ENUM('none', 'standard', 'slider', 'highImpact', 'mediumImpact', 'lowImpact', 'parallax');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_hero_size" AS ENUM('large', 'medium', 'small');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_version_hero_slides_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_version_hero_slides_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_banner_style" AS ENUM('info', 'warning', 'error', 'success');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_code_language" AS ENUM('typescript', 'javascript', 'css');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_media_block_position" AS ENUM('default', 'fullscreen');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_typography_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_typography_links_link_appearance" AS ENUM('default', 'secondary', 'none');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_typography_type" AS ENUM('sub-title-body', 'title-body', 'title', 'subtitle', 'body');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_typography_align" AS ENUM('left', 'center', 'right');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_card_type" AS ENUM('icon', 'product', 'service');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_card_icon" AS ENUM('moon', 'heart-eyes', 'swimming', 'walking', 'wave', 'theater-masks', 'heart', 'sleeping', 'stress', 'aches', 'sick');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_grid_content_content_type" AS ENUM('blocks', 'richText');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_grid_grid_style" AS ENUM('basic', 'masonry', 'responsive');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_content_columns_type" AS ENUM('blocks', 'richText');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_content_columns_align" AS ENUM('start', 'center', 'end');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_services_offerings_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_services_offerings_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_services_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_services_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_testimonials_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_testimonials_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_testimonials_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_latest_posts_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_latest_posts_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_featured_spas_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_blocks_featured_spas_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'standard', 'slider', 'highImpact', 'mediumImpact', 'lowImpact', 'parallax');
  CREATE TYPE IF NOT EXISTS "public"."enum__pages_v_version_hero_size" AS ENUM('large', 'medium', 'small');
  ...
  CREATE TYPE IF NOT EXISTS "public"."enum_product_collections_collection_type" AS ENUM('seasonal', 'promotional', 'curated');
  CREATE TYPE IF NOT EXISTS "public"."enum_product_collections_status" AS ENUM('draft', 'published');
  CREATE TYPE IF NOT EXISTS "public"."enum__product_collections_v_version_collection_type" AS ENUM('seasonal', 'promotional', 'curated');
  CREATE TYPE IF NOT EXISTS "public"."enum__product_collections_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_type" AS ENUM('hot-tub', 'swim-spa');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_hot_tub_collection" AS ENUM('self-cleaning', 'serenity');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_swim_spa_collection" AS ENUM('executive-trainer', 'executive-sport', 'aqua-trainer', 'aqua-sport', 'aqua-play');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_pure_water_system" AS ENUM('optional', 'standard');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_ez_zone_pure" AS ENUM('optional', 'standard');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_oasis_package" AS ENUM('optional', 'not-available');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_hydro_flex" AS ENUM('optional', 'not-available');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_i_command" AS ENUM('optional', 'not-available');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_northern_falls" AS ENUM('optional', 'not-available');
  CREATE TYPE IF NOT EXISTS "public"."enum_spas_chromatherapy" AS ENUM('optional', 'not-available');
  CREATE TYPE IF NOT EXISTS "public"."enum_galleries_hero_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_galleries_hero_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum_galleries_hero_slides_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_galleries_hero_slides_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE IF NOT EXISTS "public"."enum_galleries_hero_type" AS ENUM('none', 'standard', 'slider', 'highImpact', 'mediumImpact', 'lowImpact', 'parallax');
  CREATE TYPE IF NOT EXISTS "public"."enum_galleries_hero_size" AS ENUM('large', 'medium', 'small');
  CREATE TYPE IF NOT EXISTS "public"."enum_form_submissions_submission_type" AS ENUM('contact');
  CREATE TYPE IF NOT EXISTS "public"."enum_shipping_options_type" AS ENUM('pickup', 'shipping');
  CREATE TYPE IF NOT EXISTS "public"."enum_redirects_to_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_shop_settings_currency" AS ENUM('USD', 'EUR', 'GBP');
  CREATE TYPE IF NOT EXISTS "public"."enum_header_site_items_item_submenu_links_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_header_site_items_item_submenu_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_header_site_items_item_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_header_shop_items_item_submenu_links_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_header_shop_items_item_submenu_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_header_shop_items_item_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_footer_site_footer_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_footer_shop_footer_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE IF NOT EXISTS "public"."enum_store_hours_days_day_of_week" AS ENUM('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday');
