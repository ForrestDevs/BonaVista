...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "store_hours_days" ADD COLUMN IF NOT EXISTS "opentime_tz" "enum_store_hours_days_opentime_tz" DEFAULT 'America/New_York' NOT NULL;
  ALTER TABLE "store_hours_days" ADD COLUMN IF NOT EXISTS "closetime_tz" "enum_store_hours_days_closetime_tz" DEFAULT 'America/New_York' NOT NULL;
