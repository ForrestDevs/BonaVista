...
export const colorSwatchField: ColorSwatchField = ({
  ...
  return {
    ...
    validate: (value) =>
      value == null ||
      (allowHexColors && value?.match(/^#(?:[0-9a-fA-F]{3}){1,2}$/)?.length === 1) ||
      (allowTailwindColors && tailwindColorWhitelist.includes(value)) ||
    ...
    admin: {
      ...
      components: {
        Field: {
          ...
          path: '@payload/fields/color/ui/#ColorSwatchComponent',
        },
      },
    },
  }
