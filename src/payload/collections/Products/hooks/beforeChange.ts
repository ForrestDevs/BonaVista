...
//     if (data.enableVariants && data.variants?.variantProducts?.length) {
//       const variantsOrderedByPrice = data.variants?.variantProducts?.sort((a, b) => {
//         const aInfo = a?. as InfoType
