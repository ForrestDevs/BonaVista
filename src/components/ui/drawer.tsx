    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          direction === 'right' &&
            'bottom-0 top-0 right-0 left-auto mt-0 h-full w-screen max-w-[25rem] rounded-none shadow-xl overflow-hidden',
          direction === 'left' &&
            'bottom-0 top-0 left-0 right-auto mt-0 h-full w-screen max-w-[25rem] rounded-none shadow-xl overflow-hidden',
          className,
        )}
        {...props}
      >
