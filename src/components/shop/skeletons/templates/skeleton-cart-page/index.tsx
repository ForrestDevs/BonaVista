...
import SkeletonCartItem from '@/components/skeletons/components/skeleton-cart-item'
import SkeletonCodeForm from '@/components/skeletons/components/skeleton-code-form'
import SkeletonOrderSummary from '@/components/skeletons/components/skeleton-order-summary'
