...
import { CartSummaryNavInner } from '@/components/shop/layout/nav/CartSummaryNav'
import { SearchNav } from '@/components/shop/layout/nav/SearchNav'
import { NavMenu } from '@/components/shop/layout/nav/NavMenu'
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center space-x-4 sm:justify-between sm:space-x-0">
        <div className="flex gap-6 md:gap-10 mr-6">
        ...
        <div className="flex flex-1 items-center justify-end space-x-4">
          ...
          <YnsLink href="/shop/account" className="mr-6">
