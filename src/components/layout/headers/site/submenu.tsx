    ...
    submenu: [
      {
        ...
        submenu: [
          ...
          {
            label: 'Hot Tub Accessories',
            href: '/hot-tub-accessories',
          },
          {
      ...
      },
      {
        ...
        submenu: [
          ...
          {
            label: 'Swim Spa Accessories',
            href: '/swim-spa-accessories',
          },
          {
      ...
      },
      {
        ...
        submenu: [
          {
            label: 'Shop All Outdoor Living',
            href: '/shop-outdoor-living',
          },
          {
            label: 'Kitchens',
...
export const Submenus: React.FC<{ className?: string }> = ({ className }) => {
  return (
